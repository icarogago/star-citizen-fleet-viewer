  ...
  return (
    <div className="fixed left-4 top-1/2 -translate-y-1/2 flex flex-col gap-4 z-50">
      <Button
        variant="ghost"
        size="icon"
        className="bg-white/10 hover:bg-white/20 dark:bg-black/20 dark:hover:bg-black/30 backdrop-blur-sm border border-black/20 dark:border-transparent"
        asChild
      >
        <a
      ...
      >
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#5865F2] dark:text-[#7289DA] hover:text-[#4752C4] dark:hover:text-[#5B6EAE]"
        >
          <img
            src={discordIcon}
            alt="Discord"
